# monitor-sidebar-chat Specification

## Purpose
Define the persistent Foundry monitor sidebar chat, its restored session behavior, and the structured runtime context it uses.
## Requirements
