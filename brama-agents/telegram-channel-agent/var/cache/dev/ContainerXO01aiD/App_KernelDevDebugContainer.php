...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\Api\\A2AController' => 'getA2AControllerService',
            'App\\Controller\\Api\\ManifestController' => 'getManifestControllerService',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $a->pushHandler(($container->privates['monolog.handler.stdout'] ?? self::getMonolog_Handler_StdoutService($container)));
        $a->pushHandler(($container->privates['monolog.handler.stderr'] ?? self::getMonolog_Handler_StderrService($container)));
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\Api\\A2AController', 'App\\Controller\\Api\\ManifestController', 'App\\Controller\\HealthController']);
    ...
    /**
     * Gets the private 'monolog.handler.stderr' shared service.
     *
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_StderrService($container)
    {
        $container->privates['monolog.handler.stderr'] = $instance = new \Monolog\Handler\StreamHandler('php://stderr', 'error', true, NULL, false);
     ...
     * @return \Monolog\Handler\StreamHandler
     */
    protected static function getMonolog_Handler_StdoutService($container)
    {
        $container->privates['monolog.handler.stdout'] = $instance = new \Monolog\Handler\StreamHandler('php://stdout', 'info', true, NULL, false);
    ...
    private $loadedDynamicParameters = [
        ...
        'app.telegram_bot_token' => false,
        'app.telegram_webhook_secret' => false,
        'app.tasks_root' => false,
        'app.foundry_sh' => false,
        'app.pipeline_telegram_chat_id' => false,
        'app.pipeline_telegram_allowed_users' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'app.telegram_bot_token' => $container->getEnv('TELEGRAM_BOT_TOKEN'),
            'app.telegram_webhook_secret' => $container->getEnv('TELEGRAM_WEBHOOK_SECRET'),
            'app.tasks_root' => $container->getEnv('PIPELINE_TASKS_ROOT'),
            'app.foundry_sh' => $container->getEnv('FOUNDRY_SH'),
            'app.pipeline_telegram_chat_id' => $container->getEnv('PIPELINE_TELEGRAM_CHAT_ID'),
            'app.pipeline_telegram_allowed_users' => $container->getEnv('PIPELINE_TELEGRAM_ALLOWED_USERS'),
