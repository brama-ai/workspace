...
- **Summary file**: `/workspaces/brama/tasks/fix-e2e-failure-admin-agents-page-manual-openclaw-sync-butto--foundry/summary.md`
- **Next task recommendation**: Прогнати й зафіксувати результат E2E-сценарію `manual OpenClaw sync button triggers status update` після правки await.
